...
class Deoxys extends Pokemon {
  constructor() {
    super(PKM.DEOXYS, 'deoxys',[TYPE.PSYCHIC, TYPE.HUMAN], RARITY.MYTHICAL, 'february', 386, '', 300, 30, 5, 5, 1, 'PSYCHIC/melee', ATTACK_TYPE.PHYSICAL, 2, 100, SPECIAL_SKILL.PROTECT);
  }
}
